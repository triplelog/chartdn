...
void Method(const Nan::FunctionCallbackInfo<v8::Value>& info) {
	...
	retobj->Set(isolate.GetContext(),v,v8::Number::New(isolate,x.v));
	retobj->Set(isolate.GetContext(),w,v8::Number::New(isolate,x.w));
	retobj->Set(isolate.GetContext(),t,v8::String::NewFromUtf8(isolate,&x.t);
