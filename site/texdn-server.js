...
function convertDataToFull(dataStr,nHeaders) {
	...
	for (var i=0;i<10000;i++) {var xx = Math.random()+i;};//.7-5.5
	var t6 = performance.now();
	let vmresult3 = vm.run("for (var i=0;i<10000;i++) {var xxx = Math.random()+i;}");//30-220
	var t7 = performance.now();
	eval("for (var i=0;i<10000;i++) {var xxx = Math.random()+i;}");//-41
