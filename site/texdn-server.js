  ...
  ws.on('message', function incoming(message) {
  	...
  	if (dm.operation == 'upload'){
		...
		chartData = false;
  		...
  		var dotnet = 'dotnet python/qr-art/src/qr-art/bin/Debug/netcoreapp3.1/qr-art.dll "https://chartdn.com/charts/yoigjmppb" static/images/favicon.png png static/images/testnew.png -t 12 -e H';
